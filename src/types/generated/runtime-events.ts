...
export type RuntimeEventKind = "messageDelta" | "messageComplete" | "toolUse" | "diff" | "usage" | "approvalRequest" | "lifecycle" | "error" | "diagnostic";

export type RuntimeLifecycleState = "spawning" | "ready" | "exited" | "failed";

export type RuntimeEventPayload = { "type": "messageDelta", delta: string, } | { "type": "messageComplete", message: string, } | { "type": "toolUse", toolName: string, callId: string | null, status: string, detail: string | null, } | { "type": "diff", diff: string, } | { "type": "usage", inputTokens: number, cachedInputTokens: number, outputTokens: number, } | { "type": "approvalRequest", requestId: string, method: string, reason: string | null, command: string | null, cwd: string | null, } | { "type": "lifecycle", state: RuntimeLifecycleState, detail: string | null, } | { "type": "error", code: string, message: string, recoverable: boolean, } | { "type": "diagnostic", message: string, };
